...
from app.models.contact_reason import (
    ContactsReceived,
    ContactsReason,
    THTHighByAgent
)
...
async def bulk_upsert_contacts_received(
    ...
    # 🔴 IMPORTANTE: commit antes de leer
    await session.commit()

    # =========================
    # 🔥 RECONSTRUIR parent_map
    # =========================

    # construir lista de claves únicas desde data
    keys = list({
        (
            r["team"],
            r["date_pe"],
